...
class PageContent extends BaseModule {
    ...
    checkItem(index, cindex) {
        ...
        if (cindex > -1) {
            ...
            data[index].checked = data[index].children.every(data => {
                return data.checked;
            });
        } else {
            data[index].checked = !checked;
            data[index].children.map(data => {
                if (data.checked != 2) {
    ...
    toRender() {
        ...
        return (
            <div className="cart-content m-layout">
                <Store checkItem={this.checkItem.bind(this)} count={this.count} data={data.data} />
                <Footer
                    price={data.price}
        ...
        var dataList = this.props.data.map((data, index) => {
            ...
            return (
                <li key={index}>
                    ...
                    <a className="u-item-list" href="#" data-page="goodsDetails">
                        <div className="thumb">
                            <img src={data.src} />
                        </div>
                        <div className="info">
            ...
            <div className="cart-footer-bar footer">
                <div className="toolbar tabbar-labels">
                    <div className="toolbar-inner">
                        <div className="check-box" onClick={this.check.bind(this)}>
                            <i className={checkClass}></i>
                        </div>
                        <div className="text">
                            <p>商品金额：</p>
